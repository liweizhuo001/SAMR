...
public class MIPPcopy {
	...
	Path mapping1;
	Path mapping2;	
	Map<Integer, Set<Integer>> sourceRel;
	Map<Integer, Set<Integer>> targetRel;
	...
	public MIPPcopy()
	{
		...
		mapping1 =new Path();
		mapping2 =new Path();		
		sourceRel=new HashMap<Integer, Set<Integer>> ();
		targetRel=new HashMap<Integer, Set<Integer>> ();
	...
	public void init(int concept,List<Integer> C1,List<Integer>C2, Path m1,Path m2, Map<Integer, Set<Integer>>
	sRel, Map<Integer, Set<Integer>> tRel, HashMap<Path, Set<Integer>> comEntailment)
	{
	...
	public Map<Integer, Set<Integer>> getSourceRel()
	{
		return sourceRel;
	}
	
	public Map<Integer, Set<Integer>> getTargetRel()
	{
		return targetRel;
	}
