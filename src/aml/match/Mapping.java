...
//Public Methods
	...
	/*public boolean equals(Object o)
	{
	 ...
	 public boolean equals(Object o) 
	 {
	        ...
	        Mapping m = (Mapping)o;
	        /*return (this.sourceId == m.sourceId && this.targetId == m.targetId
	        		&&this.getStatus().equals(m.getStatus())&&this.getRelationship().equals(m.getRelationship()));*/
	        return (this.sourceId == m.sourceId && this.targetId == m.targetId
	        		&&this.getRelationship().equals(m.getRelationship()));
	  }
	...
	public int hashCode() 
	{
	        final int prime = 13;
	        int result = 1;
	        Integer source=this.sourceId;
	        Integer target=this.targetId;
	        result = prime * result+source.hashCode()+target.hashCode();
	        return result;
	}
